...
<div class="p-6 shadow-lg rounded-lg bg-gray-100 text-gray-700 mx-12 lg:mx-72 slide-up">
  ...
  <div class="flex flex-row space-x-4 justify-center mt-4">
    <MyIcon href="https://www.facebook.com/teelyjc/" image="/icons/iconmonstr-facebook.png" alt="facebook icon" />
    <MyIcon href="https://www.instagram.com/teelyyy.k/" image="/icons/iconmonstr-instagram.png" alt="facebook icon" />
    <MyIcon href="https://github.com/teely44y" image="/icons/iconmonstr-github.png" alt="facebook icon" />
    <MyIcon href={ discordData.instant_invite } image="/icons/iconmonstr-discord.png" alt="facebook icon" />
  </div>
  {/if}
